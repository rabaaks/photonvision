...
import org.photonvision.tensorrt.TensorRTJNI;
...
public class TensorRTObjectDetector implements ObjectDetector {
    private static final Logger logger = new Logger(TensorRTDetectorJNI.class, LogGroup.General);
    ...
    public TensorRTObjectDetector(TensorRTModel model, Size inputSize) {
        ...
        } else if (!TensorRTJNI.isQuantized(objPointer)) {
    ...
    public List<NeuralNetworkPipeResult> detect(Mat in, double nmsThresh, double boxThresh) {
        ...
        var results = TensorRTJNI.detect(objPointer, letterboxed.getNativeObjAddr(), nmsThresh, boxThresh);
    ...
    public void release() {
        ...
        if (released.compareAndSet(false, true)) {
            ...
            TensorRTJNI.destroy(objPointer);
